...
<body>
        <?php 
                 ...
                 $stmt = $database->query("SELECT *  FROM spouse WHERE id = '$id'");
            ...
            $stmts = $database->query("UPDATE spouse SET 
                 ...
                 <div class="col-lg-9 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">EDIT Spouse Information</strong>
                                        <?php  
                                             $values['id']= $row['patner'];
